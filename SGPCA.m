...
for i = 1:MAX_ITER
     ...
     for l = 1:length(group_num)
         ...
         Z2(sel,:)=shrinkage2(P(sel,:)+U2(sel,:)/rho,(1-alpha)*lambda*sqrt(group_num(l))/rho);
    ...
    if (history.P_Z1(i) + history.P_Z2(i) < epsilon)
         break;
    end
